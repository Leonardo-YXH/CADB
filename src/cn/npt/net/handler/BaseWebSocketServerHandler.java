...
public abstract class BaseWebSocketServerHandler  extends BaseYHandler {

	protected String webSocketPath;
	protected WebSocketServerHandshaker handshaker;
	protected boolean ssl;
    private static Logger log=Logger.getLogger(BaseWebSocketServerHandler.class);
    
    public BaseWebSocketServerHandler(String webSocketPath,boolean ssl) {
    ...
    public abstract void doReceive(String req,ChannelHandlerContext ctx);
